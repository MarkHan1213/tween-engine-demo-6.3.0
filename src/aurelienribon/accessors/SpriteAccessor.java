 ...
 *
 * accessor 访问
 * 继承TweenAccessor,重写getValues和setValues
 * api里接口是:TweenAccessor<T>.使用了泛型技术.
 * 这里使得Sprite的属性和Tween的值结合起来了.
 */
public class SpriteAccessor implements TweenAccessor<Sprite> {
	public static final int POS_XY = 1;		// sprite的原点
	public static final int CPOS_XY = 2;	// sprite的中心点
	public static final int SCALE_XY = 3;	// 缩放
	public static final int ROTATION = 4;	// 旋转
	public static final int OPACITY = 5;	// alpha值
	public static final int TINT = 6;		// rgb
	...
	public int getValues(Sprite target, int tweenType, float[] returnValues) {
		switch (tweenType) {
			case POS_XY:
				...
				return 2;	// 返回值表示returnValues数组长度
